...
public class MQListener implements JmsListener {
	...
	@Autowired
	private Map<String, FPSTransform> transforms;
    ...
    public void onMessage(Message message) {
        ...
        try {
	        ...
	        if (source != null) {
	        		...
	        		String packageName = fpsMessage.getClass().getPackage().getName();
	        		String beankey = "transform_" + packageName.substring(packageName.lastIndexOf("."));
	        		Object avroFpsMessage = transforms.get(beankey).fps2avro(fpsMessage);
