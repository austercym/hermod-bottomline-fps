...
public class ConversionBuilderRule implements BuilderRuleIf {
	...
	/* (non-Javadoc)
	 * @see com.hermod.bottonline.fps.services.transform.helper.ConversionRuleIf#apply(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.hermod.bottonline.fps.services.transform.helper.ConversionRuleIf#toString()
	 */
	@Override
