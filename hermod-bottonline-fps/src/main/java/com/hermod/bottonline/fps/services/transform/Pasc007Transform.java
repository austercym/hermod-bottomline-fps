...
public class Pasc007Transform implements FPSTransform {
	...
	static {
		TransformationHelper.registerMapping(
			...
			com.orwellg.umbrella.avro.types.payment.iso20022.pacs.pacs007_001_05.Document.class);						
	...
	public FPSAvroMessage fps2avro(FPSMessage message) throws ConversionException {
		...
		if (!(message instanceof iso.std.iso._20022.tech.xsd.pacs_007_001.Document)) {
			throw new ConversionException("Expected Document of type " + iso.std.iso._20022.tech.xsd.pacs_007_001.Document.class.getTypeName() + " but got " + message.getClass().getName() + " instead");
		}
		
		final iso.std.iso._20022.tech.xsd.pacs_007_001.Document source = 
				(iso.std.iso._20022.tech.xsd.pacs_007_001.Document)message;
	...
	public FPSMessage avro2fps(FPSAvroMessage message) throws ConversionException {
		...
		if (!(avroMessage instanceof com.orwellg.umbrella.avro.types.payment.iso20022.pacs.pacs007_001_05.Document)) {
			throw new ConversionException("Expected Document of type " + com.orwellg.umbrella.avro.types.payment.iso20022.pacs.pacs007_001_05.Document.class.getTypeName() + " but got " + avroMessage.getClass().getName() + " instead");
		}
		
		final iso.std.iso._20022.tech.xsd.pacs_007_001.Document target = new iso.std.iso._20022.tech.xsd.pacs_007_001.Document();
