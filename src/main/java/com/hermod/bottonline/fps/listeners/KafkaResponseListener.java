...
public class KafkaResponseListener extends BaseListener implements MessageListener<String, String>, KafkaDataListener<ConsumerRecord<String, String>> {
	...
	public void onMessage(ConsumerRecord<String, String> message) {
		...
		try {
			...
			if (transform != null) {
				...
				//LOG.info("[FPS][PmtId: {}] XML Response generated for FPS inbound payment. Response: {}", key, rawMessage);
